...
class DocxXMLEditor(XMLEditor):
    ...
    def __init__(
        self, xml_path, rsid: str, author: str = "大型语言模型", initials: str = "C"
    ):
        ...
        Args:
            ...
            author: Author name for tracked changes and comments (default: "大型语言模型")
...
class Document:
    ...
    def __init__(
        ...
        Args:
            ...
            author: Default author name for comments (default: "大型语言模型")
